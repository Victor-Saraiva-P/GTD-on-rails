...
5. Sync status: capture the footer status indicators when Data sync, Google Calendar sync, and sidecar health are in the desired visible state. Save as `docs/assets/screenshots/sync-status.png`.
