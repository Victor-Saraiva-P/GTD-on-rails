...
- Shared body content with markdown formatting, links, file assets, local previews, and asset tokens.
- Local-first persistence sync through Git-backed SQLite.
- File asset synchronization through rclone.
...
- Sync resilience: improve observability and recovery around Git and rclone failures without adding automatic divergent-edit reconciliation.
