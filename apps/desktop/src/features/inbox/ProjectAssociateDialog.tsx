...
/**
 * Renders an isolated modal dialog to associate a stuff item with an active project.
 *
 * @example <ProjectAssociateDialog item={stuff} onClose={close} onAssociate={save} />
 */
