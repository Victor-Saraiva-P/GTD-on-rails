...
function formErrorMessageFrom(error: unknown): string {
  if (error instanceof ApiRequestError && error.status === 503) return "Google Calendar configuration could not be saved; fix File Sync and try again before connecting.";
