...
public class DatabaseReadinessService {
    ...
    public static final String READINESS_QUERY = "select d.environment || '|' || c.state from gtd.database_identity d join gtd.database_cutover c on c.id = true where d.id = true";
    ...
    public boolean isReady() {
        try {
            return expectedReadiness().equals(jdbcTemplate.queryForObject(READINESS_QUERY, String.class));
