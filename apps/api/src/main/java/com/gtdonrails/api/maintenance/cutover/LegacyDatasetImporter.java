...
public class LegacyDatasetImporter {
    ...
    public void clearApplicationTables() {
        jdbcTemplate.execute("DELETE FROM google_calendars");
        jdbcTemplate.execute("DELETE FROM google_credentials");
        jdbcTemplate.execute("DELETE FROM maintenance_runs");
        jdbcTemplate.execute("DELETE FROM calendars");
        jdbcTemplate.execute("DELETE FROM next_action_contexts");
        jdbcTemplate.execute("DELETE FROM next_actions");
        jdbcTemplate.execute("DELETE FROM project_items");
        jdbcTemplate.execute("DELETE FROM projects");
        jdbcTemplate.execute("DELETE FROM context_icon_assets");
        jdbcTemplate.execute("DELETE FROM item_assets");
        jdbcTemplate.execute("DELETE FROM items");
        jdbcTemplate.execute("DELETE FROM contexts");
    }

    private void importContexts(List<LegacyContextRecord> contexts) {
        String sql = "INSERT INTO contexts (id, name, created_at, updated_at, deleted_at) VALUES (?, ?, ?, ?, ?)";
    ...
    private void importItems(List<LegacyItemRecord> items) {
        String sql = "INSERT INTO items (id, title, body, status, created_at, updated_at, deleted_at) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void importItemAssets(List<LegacyItemAssetRecord> assets) {
        String sql = "INSERT INTO item_assets (id, item_id, file_name, original_file_name, content_type, size, created_at, updated_at, deleted_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void importContextIconAssets(List<LegacyContextIconAssetRecord> icons) {
        String sql = "INSERT INTO context_icon_assets (id, context_id, file_name, original_file_name, content_type, size, created_at, updated_at, deleted_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void importNextActions(List<LegacyNextActionRecord> nextActions) {
        String sql = "INSERT INTO next_actions (item_id, energy, estimated_time_minutes, date_start, date_end, time_start, time_end, all_day, deadline, status, created_at, updated_at, deleted_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void importNextActionContexts(List<LegacyNextActionContextRecord> joins) {
        String sql = "INSERT INTO next_action_contexts (next_action_id, context_id) VALUES (?, ?)";
    ...
    private void importCalendars(List<LegacyCalendarRecord> calendars) {
        String sql = "INSERT INTO calendars (item_id, scheduled_date, scheduled_time, date_start, date_end, time_start, time_end, all_day, status, created_at, updated_at, deleted_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void importMaintenanceRuns(List<LegacyMaintenanceRunRecord> runs) {
        String sql = "INSERT INTO maintenance_runs (name, last_run_at) VALUES (?, ?)";
    ...
    private void importGoogleCredentials(List<LegacyGoogleCredentialRecord> credentials) {
        String sql = "INSERT INTO google_credentials (id, access_token, refresh_token, token_type, expires_at, scope) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    private void importGoogleCalendars(List<LegacyGoogleCalendarRecord> calendars) {
        String sql = "INSERT INTO google_calendars (id, google_calendar_id, name, color_hex) VALUES (?, ?, ?, ?)";
